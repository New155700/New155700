...
// กำหนด Type ให้ชัดเจนเพื่อแก้ Build Error เรื่อง Role
...
export default function UnifiedPage() {
  ...
  // แปลง Type ของ session.user ให้รองรับ role
  const user = session?.user as CustomUser;

  // ส่วนของหน้า Admin สำหรับเจ้าของร้าน
